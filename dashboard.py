...
.refresh-btn { background: transparent; border: 1px solid rgba(0,0,0,0.08); color: #aaa; padding: 0.2rem 0.5rem; border-radius: 4px; cursor: pointer; font-size: 0.6rem; text-decoration: none; transition: all 0.15s; margin-left: 0.4rem; }
.refresh-btn:hover { border-color: rgba(0,0,0,0.2); color: #555; }
...
<div class="header-left">
    ...
    <a href="https://github.com/Tyn-Studio/photo-analytics/actions/workflows/analytics.yml" target="_blank" class="refresh-btn" title="Trigger data refresh on GitHub">Refresh</a>
</div>
<div class="controls">
